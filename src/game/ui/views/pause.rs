        ...
        children![(
            ...
            children![
                ...
                (
                    ...
                    children![UiText::new("ui.pause.title").with_size(UiTextSize::Large)]
                ),
                UiText::new("ui.settings.sfx_volume"),
                (
                    SfxVolumeSelector,
                    UiSelector::new()
                        .with_options(
                        ...
                        .with_default_index(
                            (game_audio_volume.get_sfx_volume().to_linear() * 20.0) as usize
                        )
                ),
                UiText::new("ui.settings.music_volume"),
                (
                    MusicVolumeSelector,
                    UiSelector::new()
                        .with_options(
                        ...
                        .with_default_index(
                            (game_audio_volume.get_music_volume().to_linear() * 20.0) as usize
                        )
                ),
                (
                    UiContainer::new().with_row_gap(Val::Px(8.0)).column(),
                    children![
                        UiText::new("ui.pause.enemy_path_visibility").with_size(UiTextSize::Small),
                        (
                ...
                (
                    (ButtonAction::Close, UiButton::success()),
                    children![
                        UiIcon::new(UiIconVariant::Play),
                        UiText::new("ui.pause.resume_game").auto_width()
                    ]
                ),
                (
                    (ButtonAction::RestartLevel, UiButton::primary()),
                    children![
                        UiIcon::new(UiIconVariant::Restart),
                        UiText::new("ui.pause.restart_level").auto_width()
                    ]
                ),
                (
                    (ButtonAction::BackToMenu, UiButton::danger()),
                    children![
                        UiIcon::new(UiIconVariant::Home),
                        UiText::new("ui.pause.back_to_menu").auto_width()
                    ]
                )
            ]
        )],
